...
def create_light_controls():
    ...
    for button in [ambient_light_button, point_light_button, area_light_button, directional_light_button]:
        button.setMaximumWidth(120)
        light_layout.addWidget(button)

    light_group.setLayout(light_layout)
    light_group.setMaximumWidth(160)

    return light_group, [ambient_light_button, point_light_button, area_light_button, directional_light_button]
...
def create_ui_components():
    ...
    return randomize_button, reset_button, controls_group, light_group, camera_buttons, light_buttons, [shapes_list, add_shape_button, remove_shape_button]
